...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="add video.html" class="active"><i class="fas fa-video"></i> <span>Videos</span></a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="pointsAward" min="0" value="100">
                </div>
                <div class="form-group">
                    <label for="verification_code">Verification Code/Phrase <span class="required">*</span></label>
                    <input type="text" id="verification_code" placeholder="e.g. 1234 or ABCD">
    ...
    <script>
        ...
        function resetForm() {
            ...
            document.getElementById('pointsAward').value = '100';
